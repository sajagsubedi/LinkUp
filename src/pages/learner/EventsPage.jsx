...
const Events = ({ user }) => {
  ...
  const mockEvents = [
    {
      ...
      description: 'Meet top tech companies and explore career opportunities in software development, data science, and more.',
      date: '2024-01-15',
    ...
    },
    {
      ...
      attendees: 89,
      maxAttendees: 120,
      imageUrl: 'https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&w=500'
    },
    {
      id: '3',
      title: 'Study Abroad Information Session',
      description: 'Get detailed information about study abroad programs, scholarships, and application processes.',
      date: '2024-01-20',
      ...
      attendees: 156,
      maxAttendees: 200,
      imageUrl: 'https://images.pexels.com/photos/267885/pexels-photo-267885.jpeg?auto=compress&cs=tinysrgb&w=500'
    },
    {
      id: '4',
      title: 'Startup Pitch Competition',
      description: 'Watch innovative startup ideas compete for funding and mentorship opportunities.',
      date: '2024-01-22',
    ...
    },
    {
      ...
      description: 'Connect with young professionals across various industries and expand your network.',
      date: '2024-01-25',
    ...
    },
    {
      ...
      description: 'Learn about climate change solutions and sustainable practices from industry experts.',
      date: '2024-01-28',
  ...
  const categories = ['all', 'Career', 'Workshop', 'Education', 'Competition', 'Networking', 'Conference'];
  ...
  // Returns Tailwind color classes for each event category
  const getCategoryColor = (category) => {
    const colors = {
      ...
      Networking: 'bg-yellow-100 text-yellow-600',
  ...
  <div className="min-h-[80vh] w-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-32 py-8 bg-gradient-to-br from-blue-900 to-blue-950">
      ...
      <div className="mb-8">
        ...
        <p className="text-blue-300">Find exciting events happening near you or explore opportunities further away</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-blue-800 bg-blue-900 text-blue-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          >
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm text-purple-400">by {event.organizer}</div>
      ...
      {filteredEvents.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-medium text-blue-100 mb-2">No events found</h3>
          <p className="text-blue-300">Try adjusting your search or filters to find more events.</p>
        </div>
      )}
    </div>
  );
